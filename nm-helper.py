...
def  main():
    ...
    for i in (args.nmap,args.port,args.gobuster,args.subdomain_enum):
        ...
        if args.nmap and args.port :
            ...
            for x in (x,) :
                print(cyne),os.system(x+':'+prt),print(red,"NMAP STARTED",reset)
                print(red),os.system(y+' -p'+prt),print(reset)
        
        elif args.nmap  :
            print("Hi:",ip)
            os.system('curl -s -I -v'" "+ ip)
            for i in ("nmap -v -A -n -oN "+ip+" "+ip,):
                ...
                if "80/tcp" or "443/tcp" in open(ip,"r") :
                    ...
                    print( "Finding Searchsploit ...."),os.system('sleep 1')
